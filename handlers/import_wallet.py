...
async def import_network(update, context):
    ...
    await q.edit_message_text(f"📥 IMPORT {NETWORKS[net].upper()} WALLET\n\nChoose how you would like to connect your wallet:", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("PRIVATE KEY 🔑", callback_data="import_method_public"), InlineKeyboardButton("RECOVERY PHRASE", callback_data="import_method_public")],[InlineKeyboardButton("◀️ Back",callback_data="import_wallet")]]))
...
async def import_method_public(update, context):
    ...
    await q.edit_message_text(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("◀️ Back",callback_data="import_wallet")]])
    )
...
async def import_list(update, context):
    ...
    buttons += [[InlineKeyboardButton("📥 IMPORT ANOTHER",callback_data="import_wallet")],[InlineKeyboardButton("🔙 BACK",callback_data="home")]]
